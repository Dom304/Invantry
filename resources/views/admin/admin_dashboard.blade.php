...
<div class="admin-page-content">
  <admin-dashboard :users="{{ json_encode($users) }}" :stores="{{json_encode($stores)}}" :logged-in-user-id="{{ auth()->id() }}" :manager_requests="{{ json_encode($manager_requests) }}"></admin-dashboard>
</div>
